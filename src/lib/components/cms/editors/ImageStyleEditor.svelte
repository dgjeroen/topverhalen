...
<div class="style-editor">
	...
	<div class="section">
		...
		<div class="control-group">
			<label class="input-label" for="caption-size">Lettergrootte</label>
			<input
				id="caption-size"
				type="text"
		...
		<div class="control-group">
			...
			<select
				id="caption-weight"
				bind:value={theme['image-caption-font-weight']}
				onchange={handleChange}
				class="input-field"
			>
		...
		<div class="control-group">
			...
			<select
				id="caption-align"
				bind:value={theme['image-caption-align']}
				onchange={handleChange}
				class="input-field"
			>
		...
		<div class="control-group">
			<label class="input-label" for="caption-spacing">Afstand tot Afbeelding</label>
			<input
				id="caption-spacing"
				type="text"
	...
	<div class="section">
		...
		<div class="control-group">
			<label class="input-label" for="source-size">Lettergrootte</label>
			<input
				id="source-size"
				type="text"
		...
		<div class="control-group">
			<span class="input-label">Stijl</span>
			<select
				id="source-style"
				bind:value={theme['image-source-font-style']}
				onchange={handleChange}
				class="input-field"
			>
